...
const Chatwidget = () => {
  ...
  useEffect(() => {
    addResponseMessage(
      `Welcome ${user.username}, I'm Robi 🤖🖐️ a bot. How can i help you today?`
    );
  }, []);
  const handleNewUserMessage = (newMessage) => {
    ...
    if (
      ...
      addResponseMessage(
        `You can send your number here or can directly contact the owner via +923244998039`
      );
      ...
      addResponseMessage(`I'm Robi & I'm a Bot 🤖`);
    } else {
      addResponseMessage(
